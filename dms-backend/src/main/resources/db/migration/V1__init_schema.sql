...
CREATE TABLE IF NOT EXISTS dms_building (
    id            BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_floor (
    id           BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_room (
    id            BIGINT PRIMARY KEY AUTO_INCREMENT,
    building_id   BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS dms_bed (
    id              BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_resident (
    id            BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_checkin_intake (
    id                  BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_checkin_record (
    id            BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_checkout_order (
    id                   BIGINT PRIMARY KEY AUTO_INCREMENT,
    biz_no               VARCHAR(64) NOT NULL,
    resident_id          BIGINT      NOT NULL,
...
CREATE TABLE IF NOT EXISTS dms_fee_standard (
    id            BIGINT PRIMARY KEY AUTO_INCREMENT,
    room_type     TINYINT        NOT NULL,
...
CREATE TABLE IF NOT EXISTS dms_fee_bill (
    id                BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_meter_reading (
    id              BIGINT PRIMARY KEY AUTO_INCREMENT,
    room_id         BIGINT        NOT NULL,
    period          VARCHAR(7)    NOT NULL,
...
CREATE TABLE IF NOT EXISTS dms_utility_rate (
    id                BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dms_repair_order (
    id           BIGINT PRIMARY KEY AUTO_INCREMENT,
